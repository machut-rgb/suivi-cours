                        ...
                        <main className="mt-10 flex flex-col items-center justify-center space-y-6 text-center">
                            ...
                            >
                                ...
                                <p className="mt-4 text-lg text-gray-600 dark:text-gray-400">
                                    Simplifiez la gestion des cours et suivez
                                    les progrès facilement.
                                </p>
                            </motion.div>
                            ...
                            <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                                ...
                                >
                                    <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 p-3 transition-colors group-hover:bg-blue-600">
                                        <svg
